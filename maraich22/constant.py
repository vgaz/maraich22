...
L_LEGUMES = [{"nom":"aillet",           "prixU":14/15,    "unite":UNITE_PROD_PIECE},
            {"nom":"ail",               "prixKg":14,"prixU":14/12,       },
            {"nom":"artichaut",         "prixU":0.2,      "unite":UNITE_PROD_PIECE},
            {"nom":"aubergine",         "prixU":1.8,      "unite":UNITE_PROD_PIECE},
            {"nom":"basilic",           "prixU":0.3,      "unite":UNITE_PROD_PIECE}, ## piece = brins
            {"nom":"betterave",         "prixKg":3.5,      },
            {"nom":"blette" ,           "prixKg":4,        },
            {"nom":"carotte botte",     "prixU":3.8,      "unite":UNITE_PROD_PIECE},
            {"nom":"carotte primeur",   "prixKg":3.8,      },
            {"nom":"carotte",           "prixKg":3,        },
            {"nom":"céleri branche",    "prixKg":3.2,      },
            {"nom":"céleri rave",       "prixKg":3.5, "prixU":3.5/3      },
            {"nom":"chicorée" ,      "prixU":1.2,     "unite":UNITE_PROD_PIECE},
            {"nom":"chou de bruxelles",    "prixKg":6,        },
            {"nom":"chou pommé" ,          "prixU":3.2,      "unite":UNITE_PROD_PIECE},
            {"nom":"chou blanc",       "prixU":3,        "unite":UNITE_PROD_PIECE},
            {"nom":"chou rouge" ,        "prixU":3,      "unite":UNITE_PROD_PIECE},
            {"nom":"chou brocoli" ,        "prixKg":5,   "prixU":2.5       },
            {"nom":"chou chinois" ,       "prixU":3,        "unite":UNITE_PROD_PIECE},
            {"nom":"chou romanesco",      "prixKg":3.5,      },
            {"nom":"chou fleur" ,     "prixU":4.5,      "unite":UNITE_PROD_PIECE},
            {"nom":"chou rave" ,          "prixU":1.8,      "unite":UNITE_PROD_PIECE},
            {"nom":"chou" ,       "prixKg":3.5,     "prixU":1.8,      "unite":UNITE_PROD_PIECE},
            {"nom":"ciboulette",        "prixU":1},   ## piece = petite botte
            {"nom":"ciboule",           "prixU":0.25},
            {"nom":"claytone de cuba",   "prixKg":12,       },
            {"nom":"concombre" ,        "prixU":1.3,      "unite":UNITE_PROD_PIECE},
            {"nom":"coriandre",       "prixKg":12,       "prixU":1,        "unite":UNITE_PROD_PIECE},    ## piece = bouquet
            {"nom":"courgette",          "prixU":1,        "unite":UNITE_PROD_PIECE},
            ...
            {"nom":"laitue" ,            "prixU":1.2,     "unite":UNITE_PROD_PIECE},
            {"nom":"mâche" ,            "prixKg":12,       },
            {"nom":"maïs doux",              "prixU":1.5,      "unite":UNITE_PROD_PIECE},
            {"nom":"melon",             "prixU":2.25,     "unite":UNITE_PROD_PIECE},
            {"nom":"menthe",          "prixU":1,        "unite":UNITE_PROD_BOUQUET},
            {"nom":"mizuna",            "prixKg":12,       },
            {"nom":"moutarde",         "prixKg":4,        },
            {"nom":"navet" ,             "prixKg":3,        },
